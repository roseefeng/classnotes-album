...
> 让你的课堂照片不再在手机相册里乱作一团！拍照、或从相册同步照片，自动识别并归类到对应课程。复习查阅，触手及得。

## 核心能力

- **归类**：同步相册照片，自动识别课堂笔记内容，结合拍摄时间自动归到对应课程
- **拍摄**：点击底部圆形按钮拍摄，根据时间自动归到当前正在上的课
- **搜索**：在搜索框输入关键词（如“第三章”），从板书/PPT 文字中找到对应照片
- **课程管理**：在「课程」页添加、编辑、删除课程
- **全屏查看**：点击照片进入全屏，支持双指缩放、左右滑动切换、双击放大
- **重视您的隐私**：所有图像和 ML 推理在本地浏览器完成，照片不上传服务器
